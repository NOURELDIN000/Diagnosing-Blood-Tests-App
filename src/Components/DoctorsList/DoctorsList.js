  ...
  return (
         ...
         return   (
          ...
          <div className="  col-md-6    col-lg-4  main-doc-card" key={i}>
            <div className="doc-card  ">
              <img src={doctor?.iprofile_picd} style={{ width: "100%" }} alt="" />
    ...
    {doctorsList.map((doctor, i)=>{
         ...
         return   (
          ...
          <div className="  col-md-6    col-lg-4  main-doc-card" key={i}>
            <div className="doc-card  ">
              <img  className='doc-img' src={doctor.imgUrl} style={{ }} alt="" />
              <div className="doc-card-body">
                {/* <h5> {doctorsList.doctors?.[0]?.name} </h5> */}
                <h3 className='text-center fw-bold'> <span className='fw-normal'>Doctor : </span> {doctor.name} </h3>
                <div className='doc-card-text'>
                ...
                <p className='specialof-doc'>
          <span className='fw-bold'>  Specialization :</span>    {doctor.speciality}
                </p>
                <p>
                <span className='fw-bold'>  Location :</span>   {doctor.location}
                </p>
                <p>
